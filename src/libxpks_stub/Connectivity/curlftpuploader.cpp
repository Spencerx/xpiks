...
namespace libxpks {
    namespace net {
        ...
        bool uploadFile(CURL *curlHandle, const std::shared_ptr<UploadContext> &context, CurlProgressReporter *progressReporter,
            ...
            Connectivity::fillCurlOptions(curlHandle, context, remoteUrl);
        ...
        QString generateRemoteAddress(const QString &host, const QString &filepath, const std::shared_ptr<UploadContext> &context) {
        ...
        void CurlFtpUploader::uploadBatch() {
            ...
            auto &context = m_BatchToUpload->getContext();
            ...
            QString host = Connectivity::sanitizeHost(context->m_Host);
