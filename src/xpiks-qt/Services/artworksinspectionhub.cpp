...
namespace Services {
    ...
    void ArtworksInspectionHub::handleChange(const Artworks::ArtworkMetadata *&change) {
        inspectArtwork(change);
    }

    void ArtworksInspectionHub::handleChange(const Artworks::BasicKeywordsModel *&change) {
