                    ...
                    curl_off_t ultotal, curl_off_t ulnow)
{
    ...
    Connectivity::SimpleProgressReporter *progressReporter = (Connectivity::SimpleProgressReporter *)p;
...
void setSimleProgressCallback(CURL *curlHandle, Connectivity::SimpleProgressReporter *progressReporter) {
