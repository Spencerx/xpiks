...
namespace UndoRedo {
    RemoveArtworksHistoryItem::RemoveArtworksHistoryItem(const Models::ArtItemsModel::ArtworksRemoveResult &removeResult):
        HistoryItem(),
        m_RemovedArtworksIndices(removeResult.m_Indices),
        m_UnselectAll(removeResult.m_UnselectAll)
    {
    }

    void RemoveArtworksHistoryItem::undo() {
        LOG_INFO << "#";
