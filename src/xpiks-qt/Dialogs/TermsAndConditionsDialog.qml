...
By accessing and using Xpiks (heretofore called the 'application' or the 'program'), you accept and agree to be bound by the terms and provision of this agreement. In addition, when using this particular application, you shall be subject to any posted guidelines or rules applicable to such application. Any participation in this application will constitute acceptance of this agreement. If you do not agree to abide by the above, please do not use this application.
